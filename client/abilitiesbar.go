...
func (ah AnimationHandler) DrawAbilities() {
	...
	var (
		//abilities bar
		abilitiesBar = ah.animations["abilitiesBar.png"].Sprites[0]

		//knife - used as reference
		knife = ah.animations["knife.png"].Sprites[0]
	...
	ah.animations[getSpriteName(me, model.KNIFE)].Sprites[0].Draw(win, scaled.Moved(knifeLocation))
	ah.animations[getSpriteName(me, model.HANDGUN)].Sprites[0].Draw(win, scaled.Moved(handgunLocation))
	ah.animations[getSpriteName(me, model.RIFLE)].Sprites[0].Draw(win, scaled.Moved(rifleLocation))
	ah.animations[getSpriteName(me, model.SHOTGUN)].Sprites[0].Draw(win, scaled.Moved(shotgunLocation))
...
func (ah AnimationHandler) DrawHealthbar() {
	var (
		...
		xScalefactor = ah.animations["abilitiesBar.png"].Sprites[0].Picture().Bounds().Max.X / healthBarFrame.Picture().Bounds().Max.X
		yScalefactor = ah.animations["abilitiesBar.png"].Sprites[0].Picture().Bounds().Max.Y / healthBarFrame.Picture().Bounds().Max.Y / 2
		...
		frameLocation  = pixel.Vec{win.Bounds().Max.X / 2, win.Bounds().Min.Y + ah.animations["abilitiesBar.png"].Sprites[0].Picture().Bounds().Max.Y + healthgraphic.Picture().Bounds().Max.Y/4}
		...
		healthLocation = pixel.Vec{
			...
			win.Bounds().Min.Y + ah.animations["abilitiesBar.png"].Sprites[0].Picture().Bounds().Max.Y + healthgraphic.Picture().Bounds().Max.Y/4}
	)
